...
WebUI.setText(findTestObject('Registerpage/birthday_in'), '05/10/2545')
...
WebUI.verifyMatch(autoage, '21', false)

branhtext = WebUI.getAttribute(findTestObject('Registerpage/branch_display_text'), 'placeholder', FailureHandling.STOP_ON_FAILURE)

WebUI.verifyMatch(branhtext, 'เช่น สำนักงานใหญ่', false)
